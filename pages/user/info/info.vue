...
<script>
  import cmdNavBar from "@/components/cmd-components/cmd-nav-bar/cmd-nav-bar.vue"
  import cmdPageBody from "@/components/cmd-components/cmd-page-body/cmd-page-body.vue"
  import cmdTransition from "@/components/cmd-components/cmd-transition/cmd-transition.vue"
  import cmdCelItem from "@/components/cmd-components/cmd-cell-item/cmd-cell-item.vue"
  import cmdAvatar from "@/components/cmd-components/cmd-avatar/cmd-avatar.vue"
